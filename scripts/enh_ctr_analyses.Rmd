...
The following code produces area density plots for each species in each region (NCST, CCST, WCVI, and ISC) in Appendix B. (Chinook only, but can copy code for Coho)
