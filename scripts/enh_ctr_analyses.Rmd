...
# Expanded CWT catch data by fishery for CN from EPAD
...
CN_data <- CN_dat %>%
  select(proj = PROJ_NAME, species = SPECIES_NAME, run = RUN_NAME, stock = STOCK_NAME, prod_area = PROD_AREA_CODE, tagcode = MRP_TAGCODE, OEY = RELEASE_YEAR, TotRelease, TotCatch, Escape) %>%
  distinct()
