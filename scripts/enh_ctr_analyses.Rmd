...
NCST_areaplot <- ggplot(subset(CO_catchdist, prod_area == "NCST"), aes(x = recY, y = percentage, fill = fishery)) +
  geom_area(alpha = 0.6, size = 0.4, colour = "black") +
  theme_bw() +
  theme(legend.position = "bottom",
        legend.key.size = unit(0.8, "line"),
...
CCST_areaplot <- ggplot(subset(CO_catchdist, prod_area == "CCST"), aes(x = recY, y = percentage, fill = fishery)) +
  geom_area(alpha = 0.6, size = 0.4, colour = "black") +
  theme_bw() +
  theme(legend.position = "bottom",
        legend.key.size = unit(0.8, "line"),
...
WCVI_areaplot <- ggplot(subset(CO_catchdist, prod_area == "WCVI"), aes(x = recY, y = percentage, fill = fishery)) +
  geom_area(alpha = 0.6, size = 0.4, colour = "black") +
  theme_bw() +
  theme(legend.position = "bottom",
        legend.key.size = unit(0.8, "line"),
...
ISC_areaplot <- ggplot(subset(CO_catchdist, prod_area == "ISC"), aes(x = recY, y = percentage, fill = fishery)) +
  geom_area(alpha = 0.6, size = 0.4, colour = "black") +
  theme_bw() +
  theme(legend.position = "bottom",
        legend.key.size = unit(0.8, "line"),
