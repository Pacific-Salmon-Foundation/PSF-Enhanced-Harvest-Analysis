...
irec_catch <- read_csv(here("raw", "rec_catch_data.csv"))
...
write_csv(all_catch, "./processed/harvest/totcatch/total_catch.csv")
```
...
#write_csv(CN_hatch, "./processed/harvest/totcatch/CN_total_hatchery_catch.csv")
...
#write_csv(CO_hatch, "./processed/harvest/totcatch/CO_total_hatchery_catch.csv")
```
...
#write_csv(CN_combined_catch, "./processed/harvest/totcatch/CN_ALL_catch.csv")
...
write_csv(CO_combined_catch, "./processed/harvest/totcatch/CO_ALL_catch.csv")
```
